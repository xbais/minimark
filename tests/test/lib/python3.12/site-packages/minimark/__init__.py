...
# Download SCM files for syntax heighlighting
def download_file(repo_url, commit_hash, file_path, save_dir):
    ...
    try:
        ...
        save_path = os.path.join(CWD, f"data/{repo_url.split('/')[-1].split('-')[-1]}_highlights.scm")
        ...
        if self.type == '':
            ...
            try:
                ...
                if _lang == 'mermaid':
                    ...
                    # Switch to Java
                    text_area.language = _lang # TODO : This should set syntax highlighting according to language, currently it doesn't
...
def main():
    ...
    # Download SCM Files for syntax highlighting
    # Path to the repos.txt file
    repos_file = str(Path(__file__).parent / "data" / "treesitter-grammar_repos.txt") #"/media/aakash/active/_axnet-latest/_git.rxiv/minimark/src/minimark/data/treesitter-grammar_repos.txt"
